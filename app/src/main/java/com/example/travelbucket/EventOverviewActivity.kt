...
class EventOverviewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val event2 = Event("War Memorial of Korea", "2h", "only go if the weather is good")
        val event3 = Event("Changdeokgung Palace", "3h", "you should be there before 5pm and it is closed on sunday")
